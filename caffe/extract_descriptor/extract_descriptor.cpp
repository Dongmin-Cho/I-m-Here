...
int extract_feature(string in_file_path, string out_file_path)
{
	...
	string trained = "/home/wj/work/caffe/test/vgg_face.caffemodel";
	string deply = "/home/wj/work/caffe/test/vgg_face_deploy.prototxt";
	string meandata = "/home/wj/work/caffe/test/mean.binaryproto";
    string blobname = "fc6";
